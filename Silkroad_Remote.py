...
def handle_event(t, data):
    ...
    if t == 7:
        ...
        notificationData = {"accountId":accountData["account_id"],"notificaitonCount":"0","qrId":qrId}
    ...
    if t == 5:
        ...
        notificationData = {"accountId":accountData["account_id"],"notificaitonCount":"1","qrId":qrId}
        getNotificationData = notificationData.copy()
        try:
            resp = http.request('GET', notificationPath, fields=getNotificationData,timeout=5)
        except:
